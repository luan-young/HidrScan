...
public class ImageUtil {
    ...
    public static Bitmap scaleImage(Bitmap img, float factor) {
        Matrix matrix = new Matrix();
        matrix.postScale(factor, factor);
        Bitmap sacledImg = Bitmap.createBitmap(img, 0, 0, img.getWidth(), img.getHeight(), matrix, true);
        img.recycle();
        return sacledImg;
    }
    ...
    /**
     * Adiciona lista de imagens a lista
     */
